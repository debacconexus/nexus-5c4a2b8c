...
process.env.NEXUS_NAME = process.env.NEXUS_NAME || "Immigration Case Management System";
process.env.ENTITY_LABEL = process.env.ENTITY_LABEL || "Immigration Case";
process.env.TABLE_NAME = process.env.TABLE_NAME || "immigration_case_records";
'use strict';
